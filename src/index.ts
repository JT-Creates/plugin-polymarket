    ...
    [
      {
        name: "{{name1}}",
        content: {
          text: "Hey polydawg, can you show me some active markets on Polymarket?",
        },
      },
      {
        name: "polydawg",
    ...
    [
      {
        name: "{{user1}}",
        content: {
          text: "polydawg, find details for Polymarket market ID 123456.",
        },
      },
      {
        name: "polydawg",
...
[
      {
        name: "{{user1}}",
        content: {
          text: "What are the odds on Polymarket about the upcoming election?",
        },
      },
      {
        name: "polydawg",
        content: {
          text: "Let me check the election-related markets on Polymarket for you. What's the specific election or topic?",
        },
      },
    ],
    [
    ...
    [
      {
        name: "{{user1}}",
        content: { text: "edit username and make it John" }, // Added this example
      },
      {
        name: "polydawg",
        content: {
          text: "Setting your username to John.",
        },
      },
    ],
     [
      {
        name: "{{user1}}",
        content: { text: "Hello, i would like to change my user name to John" }, // Specific example
      },
      {
        name: "polydawg",
        content: {
